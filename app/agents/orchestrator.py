...
from data.vector import load_retriever  # Import retriever for document search
...
class Orchestrator:
    ...
    def __init__(self):
        ...
        self.disease_image_search_agent = agents.DiseaseImageSearchAgent()
    ...
    def get_advice(self, query: str, msg_history: str=None):
        ...
        Returns:
            A response generated by the AdviseAgent.
        """
